...
/* generated l10n code */Scratch.translate.setup({"de":{"_Ping Cloud Data":"Ping Clouddaten"},"fi":{"_Ping Cloud Data":"Pilvidatatarkastus","_is cloud data server [SERVER] up?":"onko pilvidatapalvelin [SERVER] käytössä?"},"it":{"_Ping Cloud Data":"Ping Dati Cloud","_is cloud data server [SERVER] up?":"il server cloud [SERVER] è attivo"},"ko":{"_Ping Cloud Data":"핑 클라우드 데이터","_is cloud data server [SERVER] up?":"클라우드 데이터 서버 [SERVER]이(가) 활성화인가?"},"nb":{"_is cloud data server [SERVER] up?":"er skydata-serveren [SERVER] oppe?"},"nl":{"_Ping Cloud Data":"Cloudservers pingen","_is cloud data server [SERVER] up?":"is cloud-gegevensserver [SERVER] bereikbaar?"},"ru":{"_Ping Cloud Data":"Пинг Облачных Данных","_is cloud data server [SERVER] up?":"сервер облачных данных [SERVER] в сети?"},"zh-cn":{"_Ping Cloud Data":"检测云数据","_is cloud data server [SERVER] up?":"云服务器[SERVER]可以使用？"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
