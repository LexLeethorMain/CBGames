...
/* generated l10n code */Scratch.translate.setup({"fi":{"_Screen resolution":"Näytön resoluutio","_primary screen height":"ensisijaisen näytön korkeus","_primary screen width":"ensisijaisen näytön leveys"},"ko":{"_Screen resolution":"화면 해상도","_primary screen height":"주 화면 높이","_primary screen width":"주 화면 넓이"},"uk":{"_Screen resolution":"Розширення Екрану","_primary screen height":"висота головного екрану","_primary screen width":"ширина головного екрану"},"zh-cn":{"_Screen resolution":"屏幕分辨率","_primary screen height":"主屏幕高","_primary screen width":"主屏幕宽"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
