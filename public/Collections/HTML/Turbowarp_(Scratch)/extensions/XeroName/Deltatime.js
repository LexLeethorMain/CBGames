...
/* generated l10n code */Scratch.translate.setup({"fi":{"_Delta Time":"Delta-aika"},"ko":{"_Delta Time":"델타 타임"},"nl":{"_Delta Time":"Deltatijd"},"ru":{"_Delta Time":"Время Дельта"},"uk":{"_Delta Time":"Дельта Час"},"zh-cn":{"_Delta Time":"帧间隔"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
